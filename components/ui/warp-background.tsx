...
const Beam = ({ width, x, delay, duration }: BeamConfig) => {
...
export function WarpBackground({
  ...
  return (
    <div className={cn('relative [container-type:size]', className)} {...props}>
      <div
        style={
          {
        ...
        className="pointer-events-none absolute inset-0 overflow-hidden [clip-path:inset(0)] [perspective:var(--perspective)] [transform-style:preserve-3d]"
      >
        <div className="[transform-style:preserve-3d] [background-size:var(--beam-size)_var(--beam-size)] [background:linear-gradient(var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_-0.5px_/var(--beam-size)_var(--beam-size),linear-gradient(90deg,_var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_50%_/var(--beam-size)_var(--beam-size)] [container-type:inline-size] [height:100cqmax] [transform-origin:50%_0%] [transform:rotateX(-90deg)] [width:100cqi]">
